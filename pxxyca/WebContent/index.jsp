	...
	<div id="wrapper">
							...
							<s:iterator value="indexVO.LB_B" id="LB_B">
								<div class="swiper-slide part1_1">
									...
									<div class="img_title" style="cursor: pointer;"
										onclick="window.location='<%=basePath%>suser/news_details?news.jsj_snews_news_id=<s:property
									value="#LB_B.jsj_snews_news_id" />'">
										<s:property value="#LB_B.news_title" />
									</div>
								</div>
							</s:iterator>
						</div>
		...
		<div class="main">
			<div class="newBox info-content">
				...
				<div class="newContent info-content">
					<div class="row">
						<!--  -->
							...
							<div class="col-md-4">
								<div class="media">
									<div class="media-left media-left-change">
										<a href="#"> <img src="<%=basePath%>img/index/time.png" />
											<div class="time">
												<span><s:property
				...
				<div class="newContent info_content">
					...
					<s:iterator value="indexVO.recommend_Nine" id="RN">
						...
						<s:if test="#RN.news.news_simg=='default.jpg'">
							<div class="col-md-4 cot_content_center">
								<div class="newCot">
									<h3 class="heading"
										onclick="window.location='<%=basePath%>suser/news_details?news.jsj_snews_news_id=<s:property
						...
						<s:else>
							<div class="col-md-4 cot_content">
		...
		<div class="newBox" style="border: none;">
			<div class="newTop" style="margin-bottom: 20px;">
				<span>成果展示</span> <a
						...
						<s:iterator value="indexVO.LB_S" id="LB_S">
							<div class="swiper-slide part2_1">
								<img style="cursor: pointer;"
									...
									src="<%=basePath%>snews/img_getNewsSImg?imgName=<s:property value="#LB_S.news_simg" />">
					...
					<div class="showCot">
						<a
							href="<%=basePath%>suser/news_details?news.jsj_snews_news_id=<s:property
								...
								value="#CGZS.news.news_title" /></a><a><s:property
								value="#CGZS.news.news_gmt_show" /></a>
					</div>
				</s:iterator>
			</div>
			<div class="clear"></div>
