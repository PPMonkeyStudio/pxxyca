	...
	<div id="wrapper" style="position: fixed; top: 0; left: 0;">
		...
		<div id="sidebar-nav" class="sidebar"
			...
			<div
				...
				管理员:
				<s:property value="#session.Admin.adminAccount" />
			</div>
		...
		<!---------------------------------------------------------------------------------------------------------------------------------->
		<li><s:if
				test="page=='page_list_admin'||page=='page_list_role'||page=='page_addmo_admin'||page=='page_addmo_role'">
				<a href="#sadmin" data-toggle="collapse" class="active"> <i
					class="lnr lnr lnr-user"></i><span>管理员管理</span><i
					class="icon-submenu lnr lnr-chevron-left"></i>
				</a>
			</s:if> <s:else>
				<a href="#sadmin" data-toggle="collapse" class="collapsed"> <i
					class="lnr lnr lnr-user"></i><span>管理员管理</span><i
					class="icon-submenu lnr lnr-chevron-left"></i>
				</a>
			</s:else> <s:if
			...
			<ul class="nav">
				<li><s:if test="page=='page_list_admin'">
						<a href="<%=basePath%>Sadmin/sadmin_Admin_page_list_admin"
							class="active">管理员列表</a>
					</s:if> <s:else>
						<a href="<%=basePath%>Sadmin/sadmin_Admin_page_list_admin">管理员列表</a>
					</s:else></li>
				<li><s:if test="page=='page_addmo_admin'">
						<a href="<%=basePath%>Sadmin/sadmin_Admin_page_addmo_admin"
							class="active">管理员操作</a>
					</s:if> <s:else>
						<a href="<%=basePath%>Sadmin/sadmin_Admin_page_addmo_admin">管理员操作</a>
					</s:else></li>

				<li><s:if test="page=='page_list_role'">
						<a href="<%=basePath%>Sadmin/sadmin_Role_page_list_role"
							class="active">角色列表</a>
					</s:if> <s:else>
						<a href="<%=basePath%>Sadmin/sadmin_Role_page_list_role">角色列表</a>
					</s:else></li>
				<li><s:if test="page=='page_addmo_role'">
						<a href="<%=basePath%>Sadmin/sadmin_Role_page_addmo_role"
							class="active">角色操作</a>
					</s:if> <s:else>
						<a href="<%=basePath%>Sadmin/sadmin_Role_page_addmo_role">角色操作</a>
					</s:else></li>
			</ul>
	</div>
	</li>
