...
<body>
	...
	<div id="content_all"
		...
		<div id="main" style="width: 1200px; height: 800px; margin: 0 auto;">

			<div id="main_left" style="height: 800px; width: 800px; float: left;">
				<div id="news_list" style="height: 710px;">
					<s:iterator value="listVO.listNews" id="LN">
						...
						<br />
						<span> <s:property value="#LN.category.category_name" /> |
							<s:property value="#LN.news.news_gmt_show.substring(0,10)" /> |
							<s:property value="#LN.news.news_keywords" />
						</span>
						<br />
					</s:iterator>
				</div>
				<div id="news_page" style="color: #013364;">
					<span
				...
				<div id="news_record" style="margin-bottom: 40px;">
			...
			<div id="main_right" style="float: right;">
				...
				<div id="main_right_down" style="margin-left: 20px;">
					<p onclick="window.location='<%=basePath%>suser/news_list?listVO.date=1&listVO.pageIndex=1'">本日新闻 &gt;</p>
					<br /> <br />
					<p onclick="window.location='<%=basePath%>suser/news_list?listVO.date=2&listVO.pageIndex=1'">本周新闻 &gt;</p>
					<br /> <br />
					<p onclick="window.location='<%=basePath%>suser/news_list?listVO.date=3&listVO.pageIndex=1'">本月新闻 &gt;</p>
					<br /> <br />
				</div>
			</div>
