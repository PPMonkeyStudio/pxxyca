window.onload = function() {
	...
	function httpBackNews() {
		if (xmlHttp.readyState == 4 && xmlHttp.status == 200) {
			...
			tablec.innerHTML = "<tr><th>编号</th><th>标题</th><th>大图</th><th>小图</th><th>创建时间</th><th>是否选中</th></tr>";
			...
			for (var i = 0; i < length; i++) {
				...
				var tdSimg = document.createElement("th");
				...
				tdSimg.setAttribute("class", "table-bordered");
				...
				if (result.pageBean[i].news_simg != "default.jpg") {
					tdSimg.innerHTML = "✔";
				} else {
					tdSimg.innerHTML = "<span style='color: #ff5063;'>✘</span>";
				}
				//
